          ...
          <div id="comment-<?php comment_ID(); ?>">
            ...
            <header class="comment-meta">
              ...
              <span class="comment-author">
                ...
                if ($comment->user_id === $post->post_author) {
                  echo '<span class="comment-by-post-author"> (' . __('Author', 'reinfeld') . ')</span>';
                }
                ?>
              </span>
            ...
            <div class="comment-actions">
              <?php if ('0' == $comment->comment_approved) : ?>
                <p class="comment-awaiting-moderation"><?php _e('Your comment is awaiting moderation.', 'reinfeld'); ?></p>
              <?php endif; ?>
            </div><!-- .comment-actions -->
