<?php
/**
 * Avatar SVG Template Part
 *
 * @package Reinfeld
 */
?>
<!-- avatar-svg.php -->
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 264 280" class="<?php echo esc_attr(apply_filters('reinfeld_avatar_class', 'avatar')); ?>">
    ...
    <g transform="translate(-825.000000, -1100.000000)">
      <g transform="translate(825.000000, 1100.000000)">
        ...
        <g mask="url(#react-mask-5)">
          ...
          <g transform="translate(76.000000, 82.000000)" fill="#000">

            <g class="mouth_open" transform="translate(2.000000, 52.000000)" fill-opacity=".7">
              <path d="M40 15c0 7.732 6.268 14 14 14s14-6.268 14-14" />
            </g>

            <g class="mouth_disbelief" transform="translate(2.000000, 52.000000)" fill-opacity=".7">
              <path d="M40 29c0-7.732 6.268-14 14-14s14 6.268 14 14" />
            </g>

            <g transform="translate(2.000000, 52.000000)" class="mouth_scream">
              <defs>
                <path d="M34.008 15.136C35.128 29.124 38.235 40.993 53.996 41c15.762.007 18.92-11.943 19.998-25.994.087-1.13-.82-2.006-1.957-2.006-6.686 0-9.367 1.994-18.048 2-8.68.006-13.232-2-17.897-2-1.143 0-2.196.737-2.084 2.136Z" id="e1" />
              </defs>
              <mask id="f1" fill="#fff">
                <use xlink:href="#e1" transform="translate(54.000000, 26.999998) scale(1, -1) translate(-54.000000, -26.999998)" />
              </mask>
              <use fill-opacity=".7" transform="translate(54.000000, 26.999998) scale(1, -1) translate(-54.000000, -26.999998)" xlink:href="#e1" />
              <rect fill="#FFF" mask="url(#f1)" x="39" y="2" width="31" height="16" rx="5" />
              <g mask="url(#f1)" fill="#FF4F6D">
          ...
          <g>
            ...
            <g mask="url(#f)">
              <g transform="translate(-1.000000, 0.000000)">
                ...
                <use fill="#1F3140" xlink:href="#g" />
                <g mask="url(#h)" fill="#E8E1E1">
                  <g transform="translate(0.000000, 0.000000)">
                    <rect width="264" height="280" />
                  </g>
                </g>
                <g transform="translate(62.000000, 85.000000)">
                  <defs>
                    <filter x="-.8%" y="-2.4%" width="101.5%" height="109.8%" filterUnits="objectBoundingBox" id="i">
                  ...
                  <g filter="url(#i)" transform="translate(6.000000, 7.000000)" fill="#252C2F" fill-rule="nonzero">
                    <path d="M34 41h-2.758C17.315 41 9 33.336 9 20.5 9 10.127 10.817 0 32.53 0h2.94C57.183 0 59 10.127 59 20.5 59 32.569 48.721 41 34 41ZM32.385 6C13 6 13 12.841 13 21.502 13 28.572 16.116 37 30.97 37H34c12.365 0 21-6.373 21-15.498C55 12.84 55 6 35.615 6h-3.23Z" />
                    <path d="M96 41h-2.758C79.315 41 71 33.336 71 20.5 71 10.127 72.817 0 94.53 0h2.94C119.183 0 121 10.127 121 20.5 121 32.569 110.721 41 96 41ZM94.385 6C75 6 75 12.841 75 21.502 75 28.572 78.12 37 92.97 37H96c12.365 0 21-6.373 21-15.498C117 12.84 117 6 97.615 6h-3.23Z" />
